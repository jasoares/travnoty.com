...
describe HubsController do
  ...
  def valid_attributes
    FactoryGirl.attributes_for(:hub)
  end
  ...
  #       post :create, {:hub => { "index" => "invalid value" }}, valid_session
  #       assigns(:hub).should be_a_new(Hub)
  #     end
  ...
  #       Hub.any_instance.should_receive(:update_attributes).with({ "index" => "MyString" })
  #       put :update, {:id => hub.to_param, :hub => { "index" => "MyString" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Hub.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => hub.to_param, :hub => { "index" => "invalid value" }}, valid_session
  #       assigns(:hub).should eq(hub)
  #     end
